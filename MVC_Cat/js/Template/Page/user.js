...
MPTemplate.Page.User = function (data, options)
{
    ...
    strVar += "                        <a class=\"item\" href=\"{1}\">{0}关注<\/a>".Format(data.follows_count, user.Pages.Following(data));
    strVar += "                        <a class=\"item\" href=\"{1}\">{0}粉丝<\/a>".Format(data.followers_count, user.Pages.Follower(data));
    strVar += "                    <\/div>";
    strVar += "                <\/div>";
