...
{
    public MiaopassFileCreateFailedException()
        : base("创建文件失败")
    {
        Code = 8;
    }
...
{
    public MiaopassFileNotExistException()
        : base("文件不存在")
    {
        Code = 9;
    }
...
{
    public MiaopassTagEmptyException()
        : base("标签为空")
    {
        Code = 10;
    }
...
{
    public MiaopassTagNotExistException()
        : base("标签不存在")
    {
        Code = 11;
    }
...
{
    public MiaopassPackageNotExistException()
        : base("图包不存在")
    {
        Code = 12;
    }
...
{
    public MiaopassPackageNameConflictException()
        : base("相同标题的图包已存在")
    {
        Code = 13;
    }
...
{
    public MiaopassPictureNotExistException()
        : base("图片不存在")
    {
        Code = 14;
    }
...
{
    public MiaopassLoginErrorException()
        : base("邮箱或密码错误")
    {
        Code = 15;
    }
...
{
    public MiaopassAlreadyLoginException()
        : base("已经登录了,请退出登录后操作")
    {
        Code = 16;
    }
...
{
    public MiaopassUploadErrorException()
        : base("文件上传错误")
    {
        Code = 17;
    }
...
{
    public MiaopassInvalidImageFileException()
        : base("图像文件无效或图像格式不符合")
    {
        Code = 18;
    }
...
{
    public MiaopassParamsErrorException()
        : base("参数错误")
    {
        Code = 19;
    }
...
{
    public MiaopassDownloadFailedException()
        : base("文件下载失败")
    {
        Code = 20;
    }
